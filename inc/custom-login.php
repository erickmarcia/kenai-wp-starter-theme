<?php
if ( !function_exists( 'kenai_login_scripts' ) ):
  function kenai_login_scripts () {
...
add_action( 'login_enqueue_scripts', 'kenai_login_scripts' );

if ( !function_exists( 'kenai_login_logo_url' ) ):
  function kenai_login_logo_url () {
    return home_url();
  }
endif;

add_filter( 'login_headerurl', 'kenai_login_logo_url' );

if ( !function_exists( 'kenai_login_logo_url_title' ) ):
  function kenai_login_logo_url_title() {
      return get_bloginfo( 'title' ) . ' | ' .  get_bloginfo( 'description' );
  }
endif;

add_filter( 'login_headertitle', 'kenai_login_logo_url_title' );
?>
